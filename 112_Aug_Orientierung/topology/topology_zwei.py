...
if '__main__' == __name__:
    ...
    network.addLink(ListOpenFlowSwitch[0], ListHost[1], bw=1000,port1=2,port2=1)
    network.addLink(ListOpenFlowSwitch[0], ListOpenFlowSwitch[1], bw=1000,port1=3,port2=1)
    network.addLink(ListOpenFlowSwitch[0], ListOpenFlowSwitch[2], bw=1000,port1=4,port2=1)

    network.addLink(ListOpenFlowSwitch[1], ListOpenFlowSwitch[2], bw=1000,port1=2,port2=2)
    network.addLink(ListOpenFlowSwitch[1], ListOpenFlowSwitch[3], bw=1000,port1=3,port2=2)
    network.addLink(ListOpenFlowSwitch[1], ListOpenFlowSwitch[4], bw=1000,port1=4,port2=2)

    network.addLink(ListOpenFlowSwitch[2], ListOpenFlowSwitch[3], bw=1000,port1=3,port2=3)

    network.addLink(ListOpenFlowSwitch[3], ListHost[2], bw=1000,port1=1,port2=1)
    network.addLink(ListOpenFlowSwitch[3], ListOpenFlowSwitch[4], bw=1000,port1=4,port2=3)

    network.addLink(ListOpenFlowSwitch[4], ListHost[3], bw=1000,port1=1,port2=1)
    # 建立 Mininet
    network.build()
